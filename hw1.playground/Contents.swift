...
//: [EXPLAIN YOUR ANSWER HERE]The function declartion should be let instead of var because var is for a constant and the value didn't get changed later so it shouldn't be var
...
//: [EXPLAIN YOUR ANSWER HERE] It didnt get initialized
